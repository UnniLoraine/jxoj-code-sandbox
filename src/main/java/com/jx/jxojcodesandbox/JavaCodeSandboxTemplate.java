...
import com.jx.jxojcodesandbox.model.ExecuteMessage;
import com.jx.jxojcodesandbox.model.JudgeInfo;
import com.jx.jxojcodesandbox.utils.ProcessUtils;
...
//        2. 编译代码，得到 class 文件
        ...
        if ("编译错误".equals(compileFileExecuteMessage.getErrorMessage())){
